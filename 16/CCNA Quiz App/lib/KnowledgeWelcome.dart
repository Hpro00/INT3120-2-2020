...
class KnowledgeWelcome extends StatefulWidget{
  @override
...
class _KnowledgePageState extends State<KnowledgeWelcome>{
  ...
  void openMenu(){
    Navigator.push(context,  SlideRightRoute(page: KnowledgeCate()));
  }
  @override
              ...
              child: Container(
                ...
                child: Center(
                  child: InkWell(
                      onTap: () { /* ... */ },
                      child: Center(
                        child: Image.asset('src/Knowledge-screen2.png')
                      )
                  ),
                ),
              ),
